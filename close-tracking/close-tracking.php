...
<body style="font-family: Sukhumvit Set; height: 100%; padding: 0px; margin: 0px;">
                    ...
                    <table class="table table-striped">
                        <thead class="thead-dark text-center">
                            <tr>
                                ...
                                <th scope="col">ผู้ปิดใบงาน</th>
                                <th scope="col">วันที่ปิดงาน</th>
    ...
    <script>
        ...
        $.get("../component/aside.php", function(data) {
            ...
            $('#closeTracking').toggleClass('menu-active');
            $('#closeTracking > a').toggleClass('a-menu-active');
        });
        ...
        function retive_data() {
            ...
            $.ajax({
                url: 'close-tracking-engine/select-close-close.php',
                type: "post",
                data: {
                    json: jsonData
                },
        ...
        function changeTo_close(id, ticket_id, staff_id) {
            ...
            $.ajax({
                url: 'pendding-tracking-engine/change-to-close.php',
                type: "post",
                data: {
                    json: jsonData
                },
        ...
        function autoComplete(data, success_status) {
            ...
            <td style="color: #F50000">${data[i][0].request_status}</td> \
            <td>${data[i][0].name}</td> \
